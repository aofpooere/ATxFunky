...
-- menu
do
    local window = library:CreateWindow('ATTACK x HUB Funky Friday') do
        ...
        local folder = window:AddFolder('Credits') do
            folder:AddLabel({ text = 'Eren - UI library' })
            folder:AddLabel({ text = 'Eren - Script' })
            folder:AddLabel({ text = 'Eren - Contributor'})
        end
        ...
        window:AddButton({ text = 'Copy discord', callback = function()
              setclipboard("https://discord.gg/TzFcCjk5ZF")
        end })
        window:AddDivider()
